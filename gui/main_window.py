...
class Bridge(QObject):
    ...
    Contains methods for triggering email and document actions.
    """
    ...
    def requestDocumentSummary(self):
        ...
        # Called from document summary page when user clicks to select a file.
    ...
    def generateDocumentSummary(self):
        ...
        # When file has already been selected, calling this slot
